...
class SwiperOptionSetForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['parameters']['loopAdditionalSlides'] = [
      '#type' => 'textfield',
      '#element_validate' => ['_views_slideshow_swiper_validate_integer_non_negative'],
    ...
    foreach (array_keys($options) as $key) {
      ...
      $form['parameters'][$key]['#default_value'] = (!isset($current) || is_null($current)) ? $options[$key]['default'] : $current;
    }
